...
function DirtyMatchaVCS() {
  ...
  // Fixed resetColor function - just resets the color without rebuilding the entire UI
  function resetColor(btn) {
    btn.style.backgroundColor = "#f9f9f9";
    btn.style.color = "#000";
  }
...
function viewCoffeesSkip() {
  ...
  searchBox.type = "text";
  searchBox.placeholder = "Search drinks or coffees...";
  searchBox.style.position = "absolute";
  searchBox.style.top ="21vh";       // just below the title
  searchBox.style.left ="65vw";
  searchBox.style.width ="18vw";
  searchBox.style.height = "5vh";
  searchBox.style.fontSize = "1.2vw";
  searchBox.style.padding = "0.8vh 1vw";
  searchBox.style.borderRadius = "1vw";
  searchBox.style.border = "0.2vw solid #ccc";
  searchBox.style.fontFamily = "JUA, sans-serif";
  body.appendChild(searchBox);
  // ================================

const filters = [
  { label: "Coffee Based:", id: "coffeeCheckbox", left: "15.6vw" },
  { label: "Non-Coffee Based:", id: "nonCoffeeCheckbox", left: "30.6vw" },
  { label: "ALL Drinks:", id: "allCheckbox", left:"51vw" },
];

filters.forEach((filter) => {
  // Create container for label and checkbox
  const container = document.createElement("div");
  container.style.position = "absolute";
  container.style.left = filter.left;
  container.style.top = "19vh";
  ...
  lbl.setAttribute("for", filter.id);
  lbl.style.fontFamily = "JUA, sans-serif";
  lbl.style.fontSize = "2vw";
  lbl.style.color = "black";
  lbl.style.marginBottom = "3vh";

  // Create checkbox
  const checkbox = document.createElement("input");
  checkbox.type = "checkbox";
  checkbox.id = filter.id;
  checkbox.style.transform = "scale(2.9)";
...
const container = document.createElement("div");
container.style.position = "absolute";
container.style.top = "37vh";
container.style.left = "11vw";
...
container.style.gap = "3vw";
document.body.appendChild(container);

// Add custom CSS for scrollbar thickness using JavaScript
const style = document.createElement('style');
style.innerHTML = `
  /* For WebKit browsers (Chrome, Edge, Safari) */
  div::-webkit-scrollbar {
    width: 2vw;  /* Change this value to make the scrollbar thicker */
  }
...
document.head.appendChild(style);
  ...
  function renderDrinks() {
    ...
    const filtered = drinkList.filter((drink) => {
      const matchesType =
        selectedType === "all" ? true : drink.type === selectedType;
      const matchesSearch = drink.name.toLowerCase().includes(searchTerm);
  ...
  filtered.forEach((drink) => {
    ...
    // IMAGE RESIZING CONTAINER
      ...
      itemContainer.style.width = "15vw";
      itemContainer.style.height = "17vw"; // Fixed height for consistent layout
      ...
      img.style.border = "0.4vw solid white";
  ...
  // ====== ADD SEARCH BOX EVENT LISTENER HERE ======
...
function feedback() {
  ...
  starContainer.style.fontSize = "7vw";
  starContainer.style.margin = "1vh 0";
  ...
  function updateStars() {
    stars.forEach((star, index) => {
      ...
      star.style.color = index < selectedRating ? "#02991b" : "black";
    });
  }
  ...
  button.style.fontSize = "3.3vw";
  button.style.fontFamily = "JUA, sans-serif";

  const errorMsg = document.createElement("p");
  errorMsg.textContent = "Please select a star!";
  errorMsg.style.color = "red";
  errorMsg.style.fontSize = "2vw";
  errorMsg.style.fontFamily = "JUA, sans-serif";
  errorMsg.style.marginTop = "2vh";
  ...
  button.addEventListener("mouseleave", () => {
   ...
   button.addEventListener("click", () => {
    if (selectedRating === 0) {
      ...
      message.textContent = "";
      return;  // Stop here if no star selected
    }
    errorMsg.style.display = "none";

    const ratingText = `${selectedRating} Star${selectedRating !== 1 ? "s" : ""}`;
